...
<xsl:stylesheet version="1.0" xmlns:xp20="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.Xpath20" xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/" xmlns:bpel="http://docs.oasis-open.org/wsbpel/2.0/process/executable" xmlns:msg_in_out="http://www.oracle.com/spm/generic/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:pc="http://xmlns.oracle.com/pcbpel/" xmlns:bpm="http://xmlns.oracle.com/bpmn20/extensions" xmlns:ph="http://xmlns.oracle.com/pcbpel/adapter/aq/headers/payloadheaders/" xmlns:plt="http://schemas.xmlsoap.org/ws/2003/05/partner-link/" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:ora="http://schemas.oracle.com/xpath/extension" xmlns:tns="http://xmlns.oracle.com/pcbpel/adapter/AQ/SPM/MISIMDOMNotifySPM/DequeueOrderDetailsForSPM" xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator" xmlns:obj1="http://xmlns.oracle.com/xdb/APPS" xmlns:mhdr="http://www.oracle.com/XSL/Transform/java/oracle.tip.mediator.service.common.functions.MediatorExtnFunction" xmlns:oraext="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.ExtFunc" xmlns:dvm="http://www.oracle.com/XSL/Transform/java/oracle.tip.dvm.LookupValue" xmlns:hwf="http://xmlns.oracle.com/bpel/workflow/xpath" xmlns:ns1="http://www.oracle.com/spm" xmlns:jca="http://xmlns.oracle.com/pcbpel/wsdl/jca/" xmlns:ns0="http://xmlns.oracle.com/pcbpel/adapter/http/SPM/MISIMDOMNotifySPM/SPMGenericWS" xmlns:med="http://schemas.oracle.com/mediator/xpath" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ids="http://xmlns.oracle.com/bpel/services/IdentityService/xpath" xmlns:xdk="http://schemas.oracle.com/bpel/extension/xpath/function/xdk" xmlns:xref="http://www.oracle.com/XSL/Transform/java/oracle.tip.xref.xpath.XRefXPathFunctions" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:missemXMLContentFunctions="http://www.oracle.com/XSL/Transform/java/com.oracle.missem.contentmgmt.XMLContentHandler" xmlns:ldap="http://schemas.oracle.com/xpath/extension/ldap" xmlns:oracle-xsl-mapper="http://www.oracle.com/xsl/mapper/schemas" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java" exclude-result-prefixes="xsi oracle-xsl-mapper oraxsl xsl msg_in_out pc ph plt wsdl tns obj1 ns1 jca xsd ns0 xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref ldap" xmlns:ns2="http://www.oracle.com/spm/generic/" xmlns:ns3="http://xmlns.oracle.com/oih/oracle_integration_message">
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="ORACLE_INTEGRATION_MESSAGE" namespace="http://xmlns.oracle.com/oih/oracle_integration_message"/>
      </oracle-xsl-mapper:target>
    </oracle-xsl-mapper:mapTargets>
  </oracle-xsl-mapper:schema>
  <xsl:variable name="varContactIdentifier" select="concat(&quot;_&quot;,substring (/ns1:MISIMD_SPM_SUBSCRIPTION/ns1:CONTRACT_TYPE,7, 1 ))"/>
  <xsl:template match="/">
        ...
        <msg_in_out:SPM>
          <msg_in_out:Subscription>
            <xsl:if test="/ns1:MISIMD_SPM_SUBSCRIPTION/ns1:SPM_PLAN_NUMBER = &quot;0&quot;">
              <msg_in_out:Name>
                <xsl:value-of select="/ns1:MISIMD_SPM_SUBSCRIPTION/ns1:ATTRIBUTE1"/>
              </msg_in_out:Name>
            </xsl:if>
            <xsl:if test="/ns1:MISIMD_SPM_SUBSCRIPTION/ns1:SPM_PLAN_NUMBER != &quot;0&quot;">
            ...
            <xsl:for-each select="/ns1:MISIMD_SPM_SUBSCRIPTION/ns1:LINES/ns1:MISIMD_SPM_LINES[ns1:CONTRACT_TYPE=../../ns1:CONTRACT_TYPE]">
              <msg_in_out:SubscribedService>
                ...
                <xsl:if test="string(ns1:SYNC_START_DATE_OCC)">
                  <msg_in_out:SyncStartDateOCC>
                    <xsl:value-of select="ns1:SYNC_START_DATE_OCC"/>
                  </msg_in_out:SyncStartDateOCC>
                </xsl:if>
                <xsl:if test="string(ns1:CLOUD_OPERATION_ID)">
                  <msg_in_out:CloudOperationId>
                    <xsl:value-of select="ns1:CLOUD_OPERATION_ID"/>
                  </msg_in_out:CloudOperationId>
                </xsl:if>
                <xsl:if test="string(ns1:COMMIT_SCHEDULE_ID)">
                  <msg_in_out:CommitScheduleId>
                    <xsl:value-of select="ns1:COMMIT_SCHEDULE_ID"/>
                  </msg_in_out:CommitScheduleId>
                </xsl:if>
                <xsl:if test="string(ns1:QUOTE_NUMBER)">
                  <msg_in_out:QuoteNumber>
                    <xsl:value-of select="ns1:QUOTE_NUMBER"/>
                  </msg_in_out:QuoteNumber>
                </xsl:if>
                <xsl:if test="string(ns1:CONVERSION_RATE_DATE)">
                  <msg_in_out:ConversionDate>
                    <xsl:value-of select="ns1:CONVERSION_RATE_DATE"/>
                  </msg_in_out:ConversionDate>
                </xsl:if>
                <xsl:if test="string(ns1:CONVERSION_TYPE_CODE)">
                  <msg_in_out:ConversionType>
                    <xsl:value-of select="ns1:CONVERSION_TYPE_CODE"/>
                  </msg_in_out:ConversionType>
                </xsl:if>
                <xsl:if test="string(ns1:CONVERSION_RATE)">
                  <msg_in_out:ConversionRate>
                    <xsl:value-of select="ns1:CONVERSION_RATE"/>
                  </msg_in_out:ConversionRate>
                </xsl:if>
				        <xsl:if test="string(ns1:COS_ORDER_LINEID)">
                  <msg_in_out:COSOrderLineId>
                    <xsl:value-of select="ns1:COS_ORDER_LINEID"/>
                  </msg_in_out:COSOrderLineId>
                </xsl:if>
                <xsl:if test="string(ns1:COS_ORDER_LINEID)">
                  <msg_in_out:IsVariableCommitment>
                    <xsl:value-of select="ns1:COS_ORDER_LINEID"/>
                  </msg_in_out:IsVariableCommitment>
                </xsl:if>
                <xsl:if test="string(ns1:CUSTOMER_ORDER_REF)">
                  <msg_in_out:CustomerOrderRef>
                    <xsl:value-of select="ns1:CustomerOrderRef"/>
                  </msg_in_out:IsVariableCommitment>
                </xsl:if>
                 <xsl:if test="string(ns1:IS_SELFSERVICE_PROV)">
                  <msg_in_out:IsSelfServiceProvisioning>
                    <xsl:value-of select="ns1:IS_SELFSERVICE_PROV"/>
                  </msg_in_out:IsSelfServiceProvisioning>
                </xsl:if>
                <xsl:if test="../../ns1:ORDER_DATE">
                  <msg_in_out:OrderDate>
                    <xsl:value-of select="../../ns1:ORDER_DATE"/>
                  </msg_in_out:OrderDate>
                </xsl:if>
