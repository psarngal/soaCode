...
AS
  ...
  (
    ...
    IS_PUBLIC_SECTOR          VARCHAR2(1000) ,
    IS_CHAIN_CUSTOMER         VARCHAR2(1000) ,
    CUSTOMER_CHAIN_TYPE       VARCHAR2(1000) ,
    STATIC
  FUNCTION new_instance
...
BEGIN
  ...
  IS_PUBLIC_SECTOR             => NULL ,
  IS_CHAIN_CUSTOMER            => NULL , 
  CUSTOMER_CHAIN_TYPE          => NULL
  );
  RETURN l_instance;
END new_instance;
END;
...
AS
  ...
  (
   ...
   --Changes for SPM-11135 begin- SPMPROV
    ...
    ORIGINAL_SUB_IDS             VARCHAR2(1000), --SPM-12396
    AGREEMENT_END_DATE           VARCHAR2(1000), --SPM-14231
    ULA2PAAS                     VARCHAR2(1000), --SPM-13991
    ULAORDER                     VARCHAR2(1000), --SPM-13991
    CREDIT4_REPUR_SUPP           VARCHAR2(1000), --SPM-13991
    ASSET_TRANSFER_FLAG          VARCHAR2(1000), --SPM-14298
    SYNC_START_DATE_OCC          VARCHAR2(1000), --SPM-14813
    CLOUD_OPERATION_ID           VARCHAR2(1000), --SPM-14760
    COMMIT_SCHEDULE_ID           VARCHAR2(1000), --SPM-10446
    CONVERSION_RATE_DATE         VARCHAR2(1000), --SPM-14637
    CONVERSION_TYPE_CODE         VARCHAR2(1000), --SPM-14637
    CONVERSION_RATE              VARCHAR2(1000), --SPM-14637
	  COS_ORDER_LINEID             VARCHAR2(1000), --SPM-17533
    QUOTE_NUMBER                 VARCHAR2(1000), --SPM-16173 
    CONFIG_ID                    VARCHAR2(1000),--SPM-17920
    CUSTOMER_ORDER_REF           VARCHAR2(1000),--SPM-14334
    PO_NUMBER                    VARCHAR2(1000),--SPM-14743
    ENFORCED_RATECARD            VARCHAR2(1000),--SPM-14743
	  IS_VARIABLE_COMMITMENT  	 VARCHAR2(1000),--SPM-16168
...
BEGIN
  l_instance := OSS_INTF_USER.MISIMD_SPM_LINES (
    ...
    ORIGINAL_SUB_IDS               => NULL, --SPM-12396
    AGREEMENT_END_DATE             => NULL, --SPM-14231
    ULA2PAAS                       => NULL, --SPM-13991
    ULAORDER                       => NULL, --SPM-13991
    CREDIT4_REPUR_SUPP             => NULL, --SPM-13991
    ASSET_TRANSFER_FLAG            => NULL, --SPM-14298
    SYNC_START_DATE_OCC            => NULL, --SPM-14813
    CLOUD_OPERATION_ID             => NULL, --SPM-14760
    COMMIT_SCHEDULE_ID             => NULL, --SPM-10446
    CONVERSION_RATE_DATE           => NULL, --SPM-14637
    CONVERSION_TYPE_CODE           => NULL, --SPM-14637
    CONVERSION_RATE                => NULL, --SPM-14637
	  COS_ORDER_LINEID             => NULL, --SPM-17533
    QUOTE_NUMBER                   => NULL, --SPM-16173 
    CONFIG_ID                      => NULL, --SPM-17920
    CUSTOMER_ORDER_REF             => NULL, --SPM-14334
    PO_NUMBER                      => NULL, --SPM-14743
    ENFORCED_RATECARD              => NULL, --SPM-14743
	IS_VARIABLE_COMMITMENT		   => NULL,	--SPM-16168
    BOM_COMPONENTS                => OSS_INTF_USER.MISIMD_SPM_BOM_COMPONENT_TBL(),
    ENTITLEMENT_COMPONENTS        => OSS_INTF_USER.MISIMD_SPM_ENT_COMPONENT_TBL(),
    OPTIONAL_TIERS                => OSS_INTF_USER.MISIMD_SPM_OPTIONAL_TIERS_TBL(),
    SALES_CREDIT                  => OSS_INTF_USER.MISIMD_SPM_SALES_CREDIT_TBL(),
...
AS
  ...
  (
    ...
    SUBSCRIPTION_SOURCE           VARCHAR2(1000),
...
-- $Header: MISIMD_SPM_CLOUD_WF.pls 120.56 2018/07/18 05:25:23 psarngal noship $
...
--   120.55   2018/08/04  psarngal - CF 18.8 SPM-14233,SPM-15581
-- ===========================================================================
