...
-- $Header: MISIMD_SPM_CLOUD_WF.plb 120.133 2018/06/22 06:01:47 psarngal noship $
...
--   120.133  2018/08/04  psarngal - CF 18.8 changes.
-- ===========================================================================
...
-- rdnagara
   insert_log (p_module =>'Set_SPM_info',
    ...
    --
    IF p_SPM_INTERFACE_STATUS = 'SPM_INTERFACE_FAILED' and p_SPM_INTERFACE_ERROR like '%SPM-0001:UCM_CONVERSION_FAILED%'
    AND l_count = 0 THEN
    --
    BEGIN
      --
      ...
      INTO l_responsibility_id,
        l_application_id
      FROM apps.fnd_responsibility fresp,
