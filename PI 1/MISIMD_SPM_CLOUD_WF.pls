...
AS
  ...
  (
   ...
   --Changes for SPM-11135 begin- SPMPROV
    ...
    IS_SINGLE_RATECARD           VARCHAR2(1000),--SPM-19388
    AGREEMENT_TYPE_CODE          VARCHAR2(1000),--SPM-17765 
    CUST_TRANS_REF_NUMBER        VARCHAR2(1000),--SPM-20823
...
BEGIN
  l_instance := OSS_INTF_USER.MISIMD_SPM_LINES (
    ...
    IS_SINGLE_RATECARD            => NULL,  --SPM-19388
    AGREEMENT_TYPE_CODE           => NULL,  --SPM-17765
    CUST_TRANS_REF_NUMBER         => NULL,  --SPM-20823
    BOM_COMPONENTS                => OSS_INTF_USER.MISIMD_SPM_BOM_COMPONENT_TBL(),
    ENTITLEMENT_COMPONENTS        => OSS_INTF_USER.MISIMD_SPM_ENT_COMPONENT_TBL(),
    OPTIONAL_TIERS                => OSS_INTF_USER.MISIMD_SPM_OPTIONAL_TIERS_TBL(),
    SALES_CREDIT                  => OSS_INTF_USER.MISIMD_SPM_SALES_CREDIT_TBL(),
...
-- $Header: MISIMD_SPM_CLOUD_WF.pls 120.61 2018/12/17 09:26:26 psarngal noship $
