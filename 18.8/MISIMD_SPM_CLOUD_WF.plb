...
-- $Header: MISIMD_SPM_CLOUD_WF.plb 120.137 2018/07/13 08:48:24 psarngal noship $
...
--   120.138  2018/08/04  psarngal - CF 18.8 changes.
-- ===========================================================================
...
-- rdnagara END
  ...
  INTO v_payload.LINES(v_payload.LINES.count).ORDER_LINE_ID,
   ...
   --Changes for SPM-9570 - SPMPROV
    ...
    v_payload.LINES(v_payload.LINES.count).COS_ORDER_LINEID               --SPM-17533
  FROM oe_order_lines_all ol,
    oe_order_price_attribs opa,
