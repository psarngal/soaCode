...
Step 2: Please deploy the attached jar file sca_MISIMDOMNotifySPM_rev6.7 to Critical domain, Default partition. Please use 'MISIMDOMNotifySPM_cfgplan_OIHAB.xml' as the configuration file for the deployment.
...
Step 1: Please retire the composite version MISIMDOMNotifySPM [6.6] from Critical domain, Default partition.
Step 2: Please deploy the attached jar file sca_MISIMDOMNotifySPM_rev6.7 to Critical domain, Default partition and set as default. Please use 
...
------------------------------------------------------------------------------------------------------------------------------------
Step 1: Please retire the composite version MISIMDOMNotifySPM [6.6] from Critical domain, Default partition.
Step 2: Please deploy the attached jar file sca_MISIMDOMNotifySPM_rev6.7 to Critical domain, Default partition. Please use 
