...
--   120.149  2018/11     psarngal - CF 18.11
-- ===========================================================================
...
-- rdnagara END
  ...
  opa.pricing_attribute51 SUPERSEDE_NOTES,
   ...
   --Changes for SPM-11135 begin- SPMPROV
    ...
    --(SELECT ADDITIONAL_COLUMN67 FROM misont_order_line_attribs_ext WHERE line_id = ol.line_id) CUSTOMER_ORDER_REF, --SPM-14334
    --ol.CUST_PO_NUMBER PO_NUMBER, --SPM-14743
  ...
  INTO v_payload.LINES(v_payload.LINES.count).ORDER_LINE_ID,
   ...
   --Changes for SPM-9570 - SPMPROV
    ...
    --v_payload.LINES(v_payload.LINES.count).CUSTOMER_ORDER_REF,            --SPM-14334
